import { DendronConfig, DendronError, DEngineClient, Disposable, DUser, DVault, DVaultSync, DWorkspace, DWorkspaceEntry, InstallStatus, SelfContainedVault, WorkspaceSettings } from "@dendronhq/common-all";
...
export declare class WorkspaceService implements Disposable, IWorkspaceService {
     ...
     */
    static getOrCreateConfig(wsRoot: string): import("neverthrow").ResultAsync<DendronConfig, DendronError<import("@dendronhq/common-all").StatusCodes | undefined>>;
