...
class FileStorage {
    ...
    async initNotes() {
        ...
        if (this.config.workspace.metadataStore === "sqlite") {
            ...
            const store = new PrismaSQLiteMetadataStore_1.SQLiteMetadataStore({
                wsRoot: this.wsRoot,
                force: true,
            });
            ...
            if (!(await PrismaSQLiteMetadataStore_1.SQLiteMetadataStore.isDBInitialized())) {
                await PrismaSQLiteMetadataStore_1.SQLiteMetadataStore.createAllTables();
                await PrismaSQLiteMetadataStore_1.SQLiteMetadataStore.createWorkspace(this.wsRoot);
            }
        }
        const out = await Promise.all(this.vaults.map(async (vault) => {
