...
import { SchemaModuleProps, RespV3, WriteSchemaOpts, Disposable, QuerySchemaOpts } from "../types";
/**
...
export interface ISchemaStore<K> extends Disposable {
     ...
     */
    queryMetadata(opts: QuerySchemaOpts): ResultAsync<SchemaModuleProps[], IDendronError>;
}
