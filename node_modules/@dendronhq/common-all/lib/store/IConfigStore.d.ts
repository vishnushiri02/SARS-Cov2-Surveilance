...
export declare type ConfigValue = string | number | object;
export interface IConfigStore {
    /**
     * Create a persistent dendron config
     * If a persistent dendron config exists, return an error
     */
    createConfig(wsRoot: URI, defaults?: DeepPartial<DendronConfig>): ResultAsync<DendronConfig, IDendronError>;
    /**
     * Read the entire dendron config as is
     */
    readConfig(wsRoot: URI): ResultAsync<DeepPartial<DendronConfig>, IDendronError>;
    /**
     ...
     */
    writeConfig(wsRoot: URI, payload: DendronConfig): ResultAsync<DendronConfig, IDendronError>;
    /**
     * Given mode (workspace or global), read override config
     */
    readOverride(wsRoot: URI, mode: "workspace" | "global"): ResultAsync<string, IDendronError>;
}
